''' i will be building the backend for the registration form
'''
...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        '''list of all the iputs expected from the user
        '''
        model = User
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].help_text = '<span class="form-text text-muted">\
            <small>Required. 150 characters or fewer. Letters, \
